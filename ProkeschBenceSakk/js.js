...
document.querySelectorAll('.box').forEach(item => {
    item.addEventListener('click', function () {
        ...
        //ki mit csi
        function kiKore(kapcsol) {

            // PAWN
            if (item.innerText == `${kapcsol}pawn`) {
            ...
            // KING
            if (item.innerText == `${kapcsol}king`) {
            ...
            // ROOK
            if (item.innerText == `${kapcsol}rook`) {
            ...
            // BISHOP
            if (item.innerText == `${kapcsol}bishop`) {
            ...
            // QUEEN
            if (item.innerText == `${kapcsol}queen`) {
            ...
            // KNIGHT
            if (item.innerText == `${kapcsol}knight`) {
        ...
        //kor 
        if (tog % 2 !== 0) {
            document.getElementById('tog').innerText = "Fehér kör"
            kiKore('W')
        }
        if (tog % 2 == 0) {
            document.getElementById('tog').innerText = "Fekete kör"
            kiKore('B')
        }
        lepesSzenezes()
